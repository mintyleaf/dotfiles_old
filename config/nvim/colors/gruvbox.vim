...
let s:gb.dark0       = ['#383838', 0]     " 40-40-40
...
let s:gb.light0      = ['#fbfbfb', 7]     " 253-244-193
let s:gb.light0_soft = ['#f2e5bc', 228]     " 242-229-188
let s:gb.light1      = ['#fbfbfb', 7]     " 235-219-178
...
hi! link Directory GruvboxFg0

" Titles for output from :set all, :autocmd, etc.
hi! link Title GruvboxFg0

" Error messages on the command line
call s:HL('ErrorMsg',   s:bg0, s:red, s:bold)
" More prompt: -- More --
hi! link MoreMsg GruvboxFg0
" Current mode message: -- INSERT --
hi! link ModeMsg GruvboxFg0
" 'Press enter' prompt and yes/no questions
hi! link Question GruvboxFg0
" Warning messages
